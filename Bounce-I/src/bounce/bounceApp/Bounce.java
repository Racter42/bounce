...
public class Bounce extends JPanel {
   ...
   private static final String IMAGE_FILE_PATH = "Rome.jpg";
   ...
   private void populateModel() {
      ...
      File imgFileName = new File("data/"+"Rome.jpg");
      try {
         img = ImageIO.read(imgFileName);
      }
      catch (IOException e) {
         e.printStackTrace();
      }
      _model.add(new ImageRectangleShape(1, 1, img), root);
   ...
   private void setUpEventHandlers() {
      ...
      _newShape.addActionListener(
   	 ...
   	 */
      _deleteShape.addActionListener(
         new ActionListener() {
            public void actionPerformed(ActionEvent e) {
   	 ...
   	 * selected shape.
   	 */
      _treeView.addTreeSelectionListener(
